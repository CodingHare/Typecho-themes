...
class TableOfContents_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function create_toc_with_dom($content)
    {
        ...
        $toc = '<div class="toc-index"><div class="toc-title">T.O.C. <span class="toc-toggle">[<a id="content-index-togglelink" href="javascript:content_index_toggleToc()">Hide</a>]</span></div><div id="toc-content">';
        $toc .= '';
        $last_level = 0;
        $count_h2 = 0;
        $new = $html->find('h2');
